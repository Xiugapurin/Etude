...
# def beat_detection(input_dir, output_file_name='beat_pred.json'):
#     PARAM_PATH = {
#         0: "../checkpoint/beat_transformer/fold_0_trf_param.pt",
#         1: "../checkpoint/beat_transformer/fold_1_trf_param.pt",
#         2: "../checkpoint/beat_transformer/fold_2_trf_param.pt",
#         3: "../checkpoint/beat_transformer/fold_3_trf_param.pt",
#         4: "../checkpoint/beat_transformer/fold_4_trf_param.pt",
#         5: "../checkpoint/beat_transformer/fold_5_trf_param.pt",
#         6: "../checkpoint/beat_transformer/fold_6_trf_param.pt",
#         7: "../checkpoint/beat_transformer/fold_7_trf_param.pt",
#     }

#     model = Demixed_DilatedTransformerModel(
#         attn_len=5, instr=5, ntoken=2, dmodel=256, nhead=8, d_hid=1024, nlayers=9, norm_first=True
#     )
#     model.load_state_dict(torch.load(PARAM_PATH[4], map_location=torch.device('cpu'))['state_dict'])
#     model.cuda()
#     model.eval()

#     beat_tracker = DBNBeatTrackingProcessor(min_bpm=70.0, max_bpm=250.0, fps=44100 / 1024, threshold=0.2)
#     downbeat_tracker = DBNDownBeatTrackingProcessor(
#         beats_per_bar=[3, 4], min_bpm=70.0, max_bpm=250.0, fps=44100 / 1024, threshold=0.2
#     )


#     npy_path = os.path.join(input_dir, '5stems.npy')
#     output_path = os.path.join(input_dir, output_file_name)
...
#         os.remove(npy_path)
#     except Exception as e:
#         print(f"Failed to process {npy_path}, Error: {e}")