...
This file was directly copied from the AMT-APC project:
  - Repository: https://github.com/misya11p/amt-apc
  - File Path: /models/hFT_Transformer/model_spec2midi.py

The code in the AMT-APC repository was, in turn, adapted from its
original source in Sony's hFT-Transformer project:
  - Original Repository: https://github.com/sony/hFT-Transformer
  - Original File Path: /model/model_spec2midi.py
----------------------------------------------------------------------
"""
