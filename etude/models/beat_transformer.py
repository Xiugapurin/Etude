...
This model is a key component of the beat detection process, which falls under the
'structuralize' stage of the project's workflow.

This file is adapted from the Beat-Transformer project.

  - Repository: https://github.com/zhaojw1998/Beat-Transformer
  - Original File: /code/DilatedTransformer.py
----------------------------------------------------------------------
"""
...
from .layers.dilated_transformer_layer import DilatedTransformerLayer
